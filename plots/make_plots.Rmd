...
saveRDS(arima_model_ghg_us_yearly, file = "../analyses/models/model_ghg_us_yearly.rds")
...
arima_model_ghg_us_yearly <- readRDS("../analyses/models/model_ghg_us_yearly.rds")
...
# Save the ARIMA model of US emissions
saveRDS(arima_model_ghg_us, file = "../analyses/models/model_ghg_us.rds")
...
arima_model_ghg_us <- readRDS("../analyses/models/model_ghg_us.rds")
...
# png("../back-up/plots/cumulative_emissions_us.png", width=800, height=400, units='px', res=600)
par(mar=c(4, 4, 0.2, 0.2))
...
ggsave("../back-up/plots/emissions_cumulative_us_world.png", p, width=1920, height=1080, units='px', dpi=300)
